...
{
    public int maxSpeed = 0; //The maximum speed that the car can reach in km/h.
    ...
    */
    ...
    public float flipCheckLength;
    public void HandleFlip()
    {
        Debug.DrawRay(transform.position, -transform.up * flipCheckLength);
        if (Physics.Raycast(transform.position, -transform.up * flipCheckLength))
        {
